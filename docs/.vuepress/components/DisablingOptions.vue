<template>
  <!-- Add disable by prop. Pass option key that indicates that options is disabled -->
  <ss-select :options="songs" track-by="name" search-by="name" disable-by="disabled" class="select">
      <!-- Resolve $disabled method from scot scope  -->
      <div slot-scope="{ filteredOptions, selectedOption, isOpen, pointerIndex, $selected, $disabled, $get }">
          ...
          <div v-show="isOpen" class="select-dropdown">
              ...
              <ss-select-option v-for="(song, index) in filteredOptions"
                                ...
                                :class="[
                                   ...
                                   // check if option is disabled and bind a class
                                   $disabled(song) ? 'disabled-option' : ''
                                ]"
                         class="select-option">
                {{ song.name }}
              </ss-select-option>
